...
<div>
	...
	<transition name="intro">	
		<div class="modal v" v-show="showVideo">
			...
			<p>Explicación del modelo OSI nivel Físico</p>
			<div class="contvideo">
	...
	<h1 class="titleNivel">Nivel Físico</h1>
	<p class="pregunta"> ¿Que elemento se puede conectar para que halla conexión de un PC a otro?</p>
	<form v-on:submit.prevent='submit'>
  	...
  	<div class="continput">
  		<label for="correcto">
  				<div class="imagen"></div>
  				No necesitan nada para conectarse
  		</label>	
