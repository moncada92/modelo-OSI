...
<div>
	...
	<transition name="intro">	
		<div class="modal v" v-show="showVideo">
			...
			<p>Explicación del modelo OSI nivel de Sesión</p>
			<div class="contvideo">
	...
	<h1 class="titleNivel">Nivel de Sesión</h1>
	<p class="pregunta"> ¿La capa de Sesión para que sirve?</p>
	<form v-on:submit.prevent='submit'>
  	<div class="continput">
  		<label for="incorrecto1">
  				<div class="imagen"></div>
  				Establece el puente de comunicación entre dos hosts
  		</label>	
  	...
  	<div class="continput">
  		<label for="correcto">
  				<div class="imagen"></div>
  				Guarda cuanto tiempo estuviste en una página web
  		</label>	
