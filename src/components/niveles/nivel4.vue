...
<div>
	...
	<transition name="intro">	
		<div class="modal v" v-show="showVideo">
			...
			<p>Explicación del modelo OSI nivel de Transporte</p>
			<div class="contvideo">
	...
	<h1 class="titleNivel">Nivel de Transporte</h1>
	<p class="pregunta"> ¿Este protocolo verifica que los paquetes enviados por el emisor lleguen a?</p>
