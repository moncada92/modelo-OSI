...
<div>
	...
	<transition name="intro">	
		<div class="modal v" v-show="showVideo">
			...
			<p>Explicación del modelo OSI nivel de Datos</p>
			<div class="contvideo">
	...
	<h1 class="titleNivel">Nivel de Datos</h1>
	<p class="pregunta"> ¿Donde encuentro la dirección MAC?</p>
